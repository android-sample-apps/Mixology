...
import com.yanivsos.mixological.repo.reactiveStore.IngredientParams
...
class IngredientRepository(
    ...
    private val reactiveStore: NonRemovableReactiveStore<IngredientModel, IngredientParams>,
    ...
    fun getAll(): Flow<List<IngredientModel>> {
        return reactiveStore.get(IngredientParams.All)
    }

    fun getByName(name: String): Flow<List<IngredientModel>> {
        return reactiveStore.get(IngredientParams.ByName(name))
    }
